...
const Editproduct = () => {
  ...
  useEffect(() => {
    ...
    AxiosInstance.get(`/api/admin/products/${id}`)
      .then((response) => {
        setIsChecked(response.data.status);
        setChecked(response.data.trending);
  ...
  const updateProduct = (e) => {
    ...
    formData.append("category", ProductInput.category_id);
    ...
    formData.append("trending", Checked ? 1 : 0);
    ...
    AxiosInstance.post(`api/admin/products/${id}`, formData)
      .then((response) => {
        if (response.status === 200) {
          setAlert({
            show: true,
            ...
            >
              <div className="row m-3">
                <div className="col-md-6 mb-3">
                  ...
                  />
                  <img
                    src={`https://laravel-api-production-1878.up.railway.app/${ProductInput.image}`}
                    width="50px"
                  />
                ...
                <div className="col-md-4 mb-3">
                  ...
                  />
                  <span className="text-danger">{InputErrorList.quantity}</span>
                </div>
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    ...
                    defaultValue={ProductInput.status === 1 ? true : false}
                  />
                </div>
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    ...
                    defaultValue={ProductInput.trending === 1 ? true : false}
                  />
                </div>
              </div>
